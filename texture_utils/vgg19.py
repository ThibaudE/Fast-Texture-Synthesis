...
class Vgg19:
    def __init__(self, vgg19_path=None, trainable=False, padding="SAME",
        ...
        new_data_dict = {'conv1_1': [data_dict['arr_0'].reshape((3, 3, 3, 64)), data_dict['arr_1']],
            'conv1_2': [data_dict['arr_2'].reshape((3, 3, 64, 64)), data_dict['arr_3']],
            'conv2_1': [data_dict['arr_4'].reshape((3, 3, 64, 128)), data_dict['arr_5']],
            'conv2_2': [data_dict['arr_6'].reshape((3, 3, 128, 128)), data_dict['arr_7']],
            'conv3_1': [data_dict['arr_8'].reshape((3, 3, 128, 256)), data_dict['arr_9']],
            'conv3_2': [data_dict['arr_10'].reshape((3, 3, 256, 256)), data_dict['arr_11']],
            'conv3_3': [data_dict['arr_12'].reshape((3, 3, 256, 256)), data_dict['arr_13']],
            'conv3_4': [data_dict['arr_14'].reshape((3, 3, 256, 256)), data_dict['arr_15']],
            'conv4_1': [data_dict['arr_16'].reshape((3, 3, 256, 512)), data_dict['arr_17']],
            'conv4_2': [data_dict['arr_18'].reshape((3, 3, 512, 512)), data_dict['arr_19']],
            'conv4_3': [data_dict['arr_20'].reshape((3, 3, 512, 512)), data_dict['arr_21']],
            'conv4_4': [data_dict['arr_22'].reshape((3, 3, 512, 512)), data_dict['arr_23']],
            'conv5_1': [data_dict['arr_24'].reshape((3, 3, 512, 512)), data_dict['arr_25']],
            'conv5_2': [data_dict['arr_26'].reshape((3, 3, 512, 512)), data_dict['arr_27']],
            'conv5_3': [data_dict['arr_28'].reshape((3, 3, 512, 512)), data_dict['arr_29']],
            'conv5_4': [data_dict['arr_30'].reshape((3, 3, 512, 512)), data_dict['arr_31']]}

        for layer in PARAM_SHAPE:
            if layer in new_data_dict: # Modification : data_dict --> new_data_dict
                self.data_dict[layer] = new_data_dict[layer] # Modification : data_dict --> new_data_dict
            if layer == topmost:
                print('Break :', layer)
                break
        if is_rgb_input:
            key_list = list(self.data_dict.keys())
            print('Key of data dict:', key_list)
